...
#' @param item_ids Character vector. Pocket item IDs you want to delete. Get them, e.g., via \code{pocket_get}.
...
#' @export
pocket_delete <- function(item_ids, consumer_key = Sys.getenv("POCKET_CONSUMER_KEY"),
