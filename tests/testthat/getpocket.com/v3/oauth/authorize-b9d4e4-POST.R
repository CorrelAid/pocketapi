structure(list(
  ...
  status_code = 200L, headers = structure(list(
    date = "Sun, 15 Mar 2020 11:23:51 GMT",
    ...
    NA,
    -2L
  ), class = "data.frame"), content = charToRaw("access_token=successfullaccesstokenyey"),
  date = structure(1584271431, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.018857,
